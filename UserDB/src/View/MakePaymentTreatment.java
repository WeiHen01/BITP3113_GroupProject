...
public class MakePaymentTreatment extends JFrame {
	...
	public MakePaymentTreatment() {
		...
		lblNewLabel_1.setBounds(37, 61, 147, 27);
		contentPane.add(lblNewLabel_1);
		
		textField = new JTextField();
		textField.setFont(new Font("Cambria", Font.PLAIN, 13));
		textField.setBounds(186, 64, 127, 22);
		...
		lblNewLabel_1_1.setBounds(465, 61, 106, 27);
		...
		lblNewLabel_1_1_1.setBounds(37, 97, 192, 27);
		contentPane.add(lblNewLabel_1_1_1);
		
		textField_1 = new JTextField();
		textField_1.setFont(new Font("Cambria", Font.PLAIN, 13));
		textField_1.setColumns(10);
		textField_1.setBounds(186, 98, 500, 27);
		contentPane.add(textField_1);
		
		
		
		JLabel lblNewLabel_1_1_1_1 = new JLabel("Treatment ID                   :");
		lblNewLabel_1_1_1_1.setForeground(Color.BLACK);
		lblNewLabel_1_1_1_1.setHorizontalAlignment(SwingConstants.LEFT);
		lblNewLabel_1_1_1_1.setFont(new Font("Cambria", Font.PLAIN, 14));
		lblNewLabel_1_1_1_1.setBounds(37, 138, 157, 27);
		contentPane.add(lblNewLabel_1_1_1_1);
		
		
		
		JLabel lblNewLabel_1_1_1_1_1 = new JLabel("Treatment Description :");
		...
		textField_3.setBounds(561, 404, 125, 28);
		...
		lblNewLabel_1_1_2.setBounds(405, 405, 147, 27);
		contentPane.add(lblNewLabel_1_1_2);
		
		JComboBox comboBox_1 = new JComboBox();
		comboBox_1.setFont(new Font("Cambria", Font.PLAIN, 13));
		comboBox_1.setMaximumRowCount(9999);
		comboBox_1.setModel(new DefaultComboBoxModel(new String[] {"", "cash", "debit card"}));
		comboBox_1.setSelectedIndex(0);
		comboBox_1.setBounds(568, 64, 118, 22);
		contentPane.add(comboBox_1);
		
		JComboBox comboBox_1_1 = new JComboBox();
		comboBox_1_1.setFont(new Font("Cambria", Font.PLAIN, 13));
		comboBox_1_1.setModel(new DefaultComboBoxModel(new String[] {"", "111", "112", "113", "114", "115", "116", "117", "118", "119", "120"}));
		comboBox_1_1.setSelectedIndex(0);
		comboBox_1_1.setBounds(186, 137, 127, 27);
		contentPane.add(comboBox_1_1);
		
		JLabel lblNewLabel_1_1_1_1_2 = new JLabel("Treatment Type :");
		...
		lblNewLabel_1_1_1_1_2.setBounds(318, 139, 125, 27);
		contentPane.add(lblNewLabel_1_1_1_1_2);
		
		textField_4 = new JTextField();
		textField_4.setFont(new Font("Cambria", Font.PLAIN, 13));
		textField_4.setColumns(10);
		textField_4.setBounds(425, 139, 261, 28);
		...
		lblNewLabel_2.setBounds(729, 59, 106, 27);
		contentPane.add(lblNewLabel_2);
		
		textField_5 = new JTextField();
		textField_5.setFont(new Font("Cambria", Font.PLAIN, 20));
		textField_5.setBounds(729, 92, 110, 32);
					...
					else
					{
						...
						if(input == 0)
						{
							...
							try
							{
								...
								PdfPCell cell = new PdfPCell(new Paragraph("Treatment Payment Query", FontFactory.getFont(FontFactory.HELVETICA_BOLD, 18)));
								...
								//HEADER
								PdfPCell cell1 = new PdfPCell(new Paragraph("Treatment ID", FontFactory.getFont(FontFactory.TIMES, 12, Font.BOLD)));
		...
		btnPay.setBounds(726, 390, 113, 50);
		...
		btnNewButton.setBounds(37, 400, 113, 37);
		...
		btnDelete.setBounds(722, 272, 114, 32);
		...
		btnClear.setBounds(723, 315, 113, 32);
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				treats.setTreatment_id(id);
				
				TreatmentController treatController = new TreatmentController();
				Treatment Treat = new Treatment();
				
				try {
					Treat = treatController.SearchTreatment(treats);
				} catch (ClassNotFoundException | SQLException e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
				}
				...
				if(Treat != null)
				{
					model.addRow(new Object[] {Treat.getTreatment_id(), Treat.getTreatment_name(), Treat.getTreatment_type(), Treat.getTreatment_price()});
		...
		btnAdd.setBounds(722, 227, 113, 35);
		...
		btnSearch.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				//if there is no input in the text field
					...
					if(Treat != null)
						{
							textField_4.setText(Treat.getTreatment_type());
							textField_2.setText(Treat.getTreatment_description());
