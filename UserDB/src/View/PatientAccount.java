...
public class PatientAccount extends JFrame {
	...
	public PatientAccount(int idnum) {
		...
		try {
			...
			patientController.showProfile(patient);
			textField.setText(Integer.toString(patientController.showProfile(patient).getPatient_id()));
			textField_1.setText(patientController.showProfile(patient).getPatient_name());
			textField_2.setText(patientController.showProfile(patient).getPatient_nophone());
			textField_3.setText(patientController.showProfile(patient).getPatient_email());
			textField_4.setText(patientController.showProfile(patient).getPatient_address());
			textField_5.setText(patientController.showProfile(patient).getPatient_username());
