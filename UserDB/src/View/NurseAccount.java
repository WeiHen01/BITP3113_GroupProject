...
public class NurseAccount extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					int idnum2 = 0;
					NurseAccount frame = new NurseAccount(idnum2);
	...
	public NurseAccount(int idnum) {
		...
		try {
			...
			nurseController.showProfile(nurse);
			textField.setText(Integer.toString(nurseController.showProfile(nurse).getNurse_id()));
			textField_1.setText(nurseController.showProfile(nurse).getNurse_name());
			textField_2.setText(nurseController.showProfile(nurse).getNurse_nophone());
			textField_3.setText(nurseController.showProfile(nurse).getNurse_email());
			textField_4.setText(nurseController.showProfile(nurse).getNurse_address());
			textField_5.setText(nurseController.showProfile(nurse).getNurse_username());
